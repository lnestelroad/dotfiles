...
-- Keeps page scoll in the middle of the screen
...
-- Does not save deletes into the clipboard buffer.
...
-- Scrolls through errors in a file
...
-- Turns the current file into an executable
